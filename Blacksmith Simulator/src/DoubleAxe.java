...
public class DoubleAxe extends Weapon {
	...
	DoubleAxe(){
		...
		logCost = 3;
		ironCost = 2;
		flavorText = "The double axe is the standard weapon"
				+ "\n used by Vikings and dwarves. "
				+ "\nThis can allow them to wield the axe"
				+ "\n as if it were a sword, clearing a path"
	...
	public void render(GameContainer container, StateBasedGame maingame,
		...
		try {
			...
			g.drawImage(new Image("Images/doubleaxe.png"), x, y);
